...
public class RegistrarVenta extends Registrable{
	...
	public VBox inicializarCajaCampos() {
		...
		ArrayList<String> listaEjemplo= new ArrayList<>();
		listaEjemplo.add("Kefir");
		listaEjemplo.add("Yogurt Griego"); /*Reemplazar cuando tenga el DAO*/
		...
		campos.add(this.crearCampoDesplegable("Producto", listaEjemplo));
